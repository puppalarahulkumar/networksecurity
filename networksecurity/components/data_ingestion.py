...
class DataIngestion:
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            train_set,test_set=train_test_split(dataframe,test_size=self.data_ingestion_config.train_test_split_ratio,random_state=44)
            logging.info("test and train preformed")
            ...
            logging.info("exported train and test as csv")
