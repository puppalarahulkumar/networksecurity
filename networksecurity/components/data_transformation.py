...
from networksecurity.constant.training_pipeline import DATA_TRANSORMATION_IMPUTER_PARAMS

from networksecurity.entity.artifact_entity import DataTransformationArtifact,DataValidationArtifacts
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSORMATION_IMPUTER_PARAMS)
            logging.info("initialized the knn imputer")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            preprocessor_object=preprocessor.fit(input_feature__train_df)
            transformed_input_train_feature=preprocessor_object.transform(input_feature__train_df)
